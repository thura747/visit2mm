...
# CHANGEME
env.hosts = ['user@visit2mm.example.com']
env.code_dir = '/srv/www/visit2mm'
env.project_dir = '/srv/www/visit2mm/visit2mm'
env.static_root = '/srv/www/visit2mm/static/'
env.virtualenv = '/srv/www/visit2mm/.virtualenv'
env.code_repo = 'git@github.com:user/visit2mm.git'
env.django_settings_module = 'visit2mm.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/visit2mm/wsgi.py" % env.code_dir)
